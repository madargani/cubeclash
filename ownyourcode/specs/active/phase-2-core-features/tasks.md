...
- [ ] Review Phase 1 code to understand existing patterns
- [ ] Install cubing.js dependency: `cd apps/server && npm install cubing`
...
- [ ] **Add user:register Socket.IO event**
